        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-10">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left">
            ...
            <p className="text-gray-600 mb-6">
              With over 15 years of experience in the industry, John founded Technical Pilot with a vision to revolutionize technical education. His expertise and passion for teaching have helped thousands of students achieve their career goals.
            </p>
